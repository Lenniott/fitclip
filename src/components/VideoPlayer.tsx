        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          {currentIndex > 0 && (
            <button
              ...
              className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 hover:bg-opacity-70 text-white p-3 rounded-full pointer-events-auto transition-all"
            >
          ...
          {currentIndex < exercises.length - 1 && (
            <button
              onClick={goToNext}
              className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 hover:bg-opacity-70 text-white p-3 rounded-full pointer-events-auto transition-all"
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
          ...
          <button
            onClick={goToDetails}
            className="absolute top-4 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-50 hover:bg-opacity-70 text-white px-4 py-2 rounded-lg pointer-events-auto transition-all"
          >
            <div className="flex items-center space-x-2">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-50 hover:bg-opacity-70 text-white px-4 py-2 rounded-lg pointer-events-auto transition-all"
          >
            <div className="flex items-center space-x-2">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
